...
namespace FSCTakip.DataAccess.Migrations
{
    ...
    [Migration("20260718210305_AddMachineType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSCTakip.Core.Entities.CompanySetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCTakip.Core.Entities.ConversionAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCTakip.Core.Entities.MachineType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCTakip.Core.Entities.ProductionDetailAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductionDetailAudits");
                });
            ...
            modelBuilder.Entity("FSCTakip.Core.Entities.FscLot", b =>
                {
                    ...
                    b.HasOne("FSCTakip.Core.Entities.FscSerial", "SourceSerial")
                        .WithMany()
            ...
            modelBuilder.Entity("FSCTakip.Core.Entities.Machine", b =>
                {
                    b.HasOne("FSCTakip.Core.Entities.MachineType", "MachineType")
                        .WithMany()
